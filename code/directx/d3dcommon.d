...
alias LPD3D_SHADER_MACRO = D3D_SHADER_MACRO*;

mixin DEFINE_GUID!(ID3D10Blob, "8BA5FB08-5195-40e2-AC58-0D989C3A0102");
...
alias IID_ID3DBlob = IID_ID3D10Blob;
...
alias D3D_SET_OBJECT_NAME_N_A = (pObject, Chars, pName) => pObject.SetPrivateData(WKPDID_D3DDebugObjectName, Chars, pName);
alias D3D_SET_OBJECT_NAME_A   = (pObject, pName) => D3D_SET_OBJECT_NAME_N_A(pObject, lstrlenA(pName), pName);
alias D3D_SET_OBJECT_NAME_N_W = (pObject, Chars, pName) => pObject.SetPrivateData(WKPDID_D3DDebugObjectNameW, Chars * 2, pName);
alias D3D_SET_OBJECT_NAME_W   = (pObject, pName) => D3D_SET_OBJECT_NAME_N_W(pObject, wcslen(pName), pName);
