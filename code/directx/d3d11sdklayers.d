...
enum UINT D3D11_SDK_LAYERS_VERSION = 1;
enum UINT D3D11_DEBUG_FEATURE_FLUSH_PER_RENDER_OP = 0x1;
enum UINT D3D11_DEBUG_FEATURE_FINISH_PER_RENDER_OP = 0x2;
enum UINT D3D11_DEBUG_FEATURE_PRESENT_PER_RENDER_OP = 0x4;
enum UINT D3D11_DEBUG_FEATURE_ALWAYS_DISCARD_OFFERED_RESOURCE = 0x8;
enum UINT D3D11_DEBUG_FEATURE_NEVER_DISCARD_OFFERED_RESOURCE = 0x10;
enum UINT D3D11_DEBUG_FEATURE_AVOID_BEHAVIOR_CHANGING_DEBUG_AIDS = 0x40;
enum UINT D3D11_DEBUG_FEATURE_DISABLE_TILED_RESOURCE_MAPPING_TRACKING_AND_VALIDATION = 0x80;
...
mixin DEFINE_GUID!(ID3D11Debug, "79cf2233-7536-4948-9d36-1e4692dc5760");
...
mixin DEFINE_GUID!(ID3D11SwitchToRef, "1ef337e3-58e7-4f83-a692-db221f5ed47e");
...
mixin DEFINE_GUID!(ID3D11TracingDevice, "1911c771-1587-413e-a7e0-fb26c3de0268");
// [uuid("1911c771-1587-413e-a7e0-fb26c3de0268")][object][local][pointer_default("unique")]
...
mixin DEFINE_GUID!(ID3D11RefTrackingOptions, "193dacdf-0db2-4c05-a55c-ef06cac56fd9");
// [uuid("193dacdf-0db2-4c05-a55c-ef06cac56fd9")][object][local][pointer_default("unique")]
...
mixin DEFINE_GUID!(ID3D11RefDefaultTrackingOptions, "03916615-c644-418c-9bf4-75db5be63ca0");
// [uuid("03916615-c644-418c-9bf4-75db5be63ca0")][object][local][pointer_default("unique")]
...
struct D3D11_MESSAGE
{
  ...
  D3D11_MESSAGE_ID ID;
  // [annotation("_Field_size_(DescriptionByteLength)")]
...
{
  UINT NumCategories;
  // [annotation("_Field_size_(NumCategories)")]
  D3D11_MESSAGE_CATEGORY* pCategoryList;
  UINT NumSeverities;
  // [annotation("_Field_size_(NumSeverities)")]
  D3D11_MESSAGE_SEVERITY* pSeverityList;
  UINT NumIDs;
  // [annotation("_Field_size_(NumIDs)")]
...
enum D3D11_INFO_QUEUE_DEFAULT_MESSAGE_COUNT_LIMIT = 1024;

mixin DEFINE_GUID!(ID3D11InfoQueue, "6543dbb6-1b48-42f5-ab82-e97ec74326f6");
...
extern(Windows):
  ...
  HRESULT GetMessage(
    // [annotation("_In_")]
    UINT64 MessageIndex,
    // [annotation("_Out_writes_bytes_opt_(*pMessageByteLength)")]
  ...
  HRESULT GetStorageFilter(
    // [annotation("_Out_writes_bytes_opt_(*pFilterByteLength)")]
    D3D11_INFO_QUEUE_FILTER* pFilter,
    // [annotation("_Inout_")]
